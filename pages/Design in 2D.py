...
col1.image("images/2d_design/gvlogo.jpg", width=220, caption="Logo for my climbing association")
col2.image("images/2d_design/cami.png", width=220, caption="Design for a t-shirt")
col3.image("images/2d_design/pezleon.png", width=220, caption="Tattoo design of a lionfish")
